...
public class FamilyTree //extends IOException
{
	...
	// Get parent node. If this is the 1st line of the input file, the tree is empty
	// and the parent node must be constructed. Otherwise the parent node should be 
